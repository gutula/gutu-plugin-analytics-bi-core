...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/analytics-bi-core");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-analytics-bi-core:");
...
console.log("Documentation check passed for gutu-plugin-analytics-bi-core.");
