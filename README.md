...
| Primary focus | datasets, KPIs, warehouse sync |
...
| Owned Entities | 5 | `Dataset`, `KPI Definition`, `Warehouse Sync Job`, `Analytics Exception`, `Derived Snapshot` |
| Reports | 3 | `Executive KPI Summary`, `Dataset Freshness`, `Cross-Domain Exception Dashboard` |
| Exception Queues | 3 | `warehouse-sync-failures`, `stale-kpi-refresh`, `dataset-contract-drift` |
| Operational Scenarios | 3 | `dataset-publication`, `kpi-refresh`, `warehouse-sync-enqueue` |
| Settings Surfaces | 2 | `Report Center`, `Financial Report Template` |
| ERPNext Refs | 6 | `Report Center`, `Accounts`, `Selling`, `Buying`, `Stock`, `Projects` |
...
Use the root repo scripts for day-to-day work **after the workspace is bootstrapped**, or run the nested package directly from `framework/builtin-plugins/analytics-bi-core` if you need lower-level control.
...
- `plugins/gutu-plugin-analytics-bi-core/framework/builtin-plugins/analytics-bi-core/docs/AGENT_CONTEXT.md`
- `plugins/gutu-plugin-analytics-bi-core/framework/builtin-plugins/analytics-bi-core/docs/BUSINESS_RULES.md`
- `plugins/gutu-plugin-analytics-bi-core/framework/builtin-plugins/analytics-bi-core/docs/EDGE_CASES.md`
- `plugins/gutu-plugin-analytics-bi-core/framework/builtin-plugins/analytics-bi-core/docs/FLOWS.md`
- `plugins/gutu-plugin-analytics-bi-core/framework/builtin-plugins/analytics-bi-core/docs/GLOSSARY.md`
- `plugins/gutu-plugin-analytics-bi-core/framework/builtin-plugins/analytics-bi-core/docs/MANDATORY_STEPS.md`
