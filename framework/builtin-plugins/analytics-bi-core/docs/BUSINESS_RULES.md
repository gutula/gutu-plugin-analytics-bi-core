# Analytics & BI Core Business Rules

## Invariants

- The plugin remains authoritative only for the data declared in `analytics-bi-core` and its owned resource set.
...
- ERP parity references are tracked against: `Report Center`, `Accounts`, `Selling`, `Buying`, `Stock`, `Projects`.
