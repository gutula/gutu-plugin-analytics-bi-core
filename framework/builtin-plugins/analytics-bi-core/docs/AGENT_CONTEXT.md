# Analytics & BI Core Agent Context
...
- Service layer: `framework/builtin-plugins/analytics-bi-core/src/services/main.service.ts`
- Action layer: `framework/builtin-plugins/analytics-bi-core/src/actions/default.action.ts`
- Resource layer: `framework/builtin-plugins/analytics-bi-core/src/resources/main.resource.ts`
- UI layer: `framework/builtin-plugins/analytics-bi-core/src/ui`

## Safe assumptions

- Use `analytics-bi-core` as the stable plugin identifier and `@plugins/analytics-bi-core` as the package import name.
