...
function seedState() {
  return {
    primaryRecords: [
      {
        id: "analytics-bi-core:seed",
        tenantId: "tenant-platform",
        title: "Analytics & BI Core Seed Record",
        ...
        correlationId: "analytics-bi-core:seed",
        processId: "analytics-bi-lifecycle:seed",
        upstreamRefs: [],
        downstreamRefs: [],
...
const store = createBusinessDomainStateStore({
  pluginId: "analytics-bi-core",
  sqlite: {
    primaryTable: "analytics_bi_core_primary_records",
    secondaryTable: "analytics_bi_core_secondary_records",
    exceptionTable: "analytics_bi_core_exception_records",
    dbFileName: "business-runtime.sqlite"
  },
  postgres: {
    schemaName: "analytics_bi_core"
  },
...
const service = createBusinessPluginService({
  ...
  primaryResourceId: "analytics.datasets",
  secondaryResourceId: "analytics.kpis",
  exceptionResourceId: "analytics.warehouse-sync",
  createEvent: "analytics.dataset-published.v1",
  advanceEvent: "analytics.kpi-refreshed.v1",
  reconcileEvent: "analytics.warehouse-sync-enqueued.v1",
  projectionJobId: "analytics.projections.refresh",
  reconciliationJobId: "analytics.reconciliation.run",
  advanceActionLabel: "Refresh KPI Definitions",
