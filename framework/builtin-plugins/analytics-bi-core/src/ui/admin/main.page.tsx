...
export async function BusinessAdminPage() {
  ...
  return React.createElement(
    "section",
    null,
    React.createElement("h1", null, "Analytics & BI Control Room"),
    React.createElement("p", null, "Governed business datasets, KPI posture, and warehouse-sync exception visibility."),
    React.createElement(
      "p",
      null,
